...
I created a simplified version of it that allows you to:

 Display a list of books
-[]Add a book
-[]Remove a selected book
By building this application, I have learn how to use React and Redux in the context of a real application.
...
```
git clone https://github.com/elad237/Bookstore-using-react.git
I run this command
...
Feel free to check the [issues page](https://github.com/elad237/Bookstore-using-react/issues).
